...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.findAll = function (paginationQuery) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            throw new common_1.NotFoundException("User ".concat(email, " not found"));
                        }
                        return [2 /*return*/, user];
                }
            });
    ...
    UsersService.prototype.create = function (createUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userModel.findOne({ email: createUserDto.email })];
                    case 1:
                        if (_a.sent()) {
                            throw new common_1.ConflictException("User with email ".concat(createUserDto.email, " already exists"));
                        }
